...
<details>
  <summary>How do I import my data?</summary>
  <p>To import your data, click the "Start" button in the "Visualization" or "Calibration" section. You can then select one or more files from your device.</p>
</details>

<details>
  <summary>Can I export my data to TRAC?</summary>
  <p>Yes, FluoGraphiX offers advanced tools for converting and exporting your measurement data. Go to the calculation and export utility after importing your files.</p>
</details>

<details>
  <summary>Is the application free?</summary>
  <p>FluoGraphiX is an open-source project developed by BRGM. Its use is completely free.</p>
</details>

<details>
  <summary>Is the application compatible with smartphones?</summary>
