...
!function (A, e) {
    ...
    var cn, Qn = function (A) {
        ...
        this.text = Hn(A.data, e.textTransform), this.textBounds = function (A, t, r) {
            ...
            return e.forEach(function (A) {
                if (t.textDecorationLine.length || 0 < A.trim().length) if (Oe.SUPPORT_RANGE_BOUNDS) n.push(new ln(A, gn(r, B, A.length))); else {
    ...
    var ps = function (c, Q, w, u) {
        c.container.elements.forEach(function (A) {
            var e = $r(A.flags, 4), t = $r(A.flags, 2), r = new gs(A, c.getParentEffects());
